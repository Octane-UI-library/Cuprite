...
<div class="bg-white/80 dark:bg-[#212124]/80 h-[89.5%] shadow-xl border border-white/20 dark:border-[#ffffff10] overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-200/50 dark:border-[#ffffff10] bg-gray-50/30 dark:bg-[#19191a]">
        <div class="flex items-center justify-between">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">
                <i class="ri-puzzle-2-line mr-2 text-red-500"></i>
        ...
        <table class="w-full divide-y divide-gray-200/30 dark:divide-[#ffffff10]">
            <thead class="bg-gray-50/30 dark:bg-[#19191a]">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">
                        <i class="ri-folder-2-line mr-2 text-red-500"></i>
                        Category
                    </th>
                    <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">
                ...
                @foreach($components as $component)
                    <tr class="hover:bg-gray-50/30 dark:hover:bg-[#19191a] transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap text-gray-800 dark:text-gray-200 font-medium">
                            <a href="{{ route('admin.components.show', $component->id) }}" class="flex items-center group">
                                <i class="ri-file-code-line mr-3 text-red-500"></i>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-gray-600 dark:text-gray-400">
                            @if($component->category)
                                <div class="flex items-center">
                                    <i class="{{ $component->category->icon->class ?? 'ri-folder-line' }} mr-2 text-red-500"></i>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center space-x-4">
                                <a
                                    href="{{ route('admin.components.show', $component->id) }}"
    ...
    @if($components->isEmpty())
        <div class="p-12 text-center text-gray-500 dark:text-gray-400">
            ...
            <p class="text-lg">No components found. Let's create your first one!</p>
        </div>
    @endif
</div>
@endsection
