        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="p-6 bg-white/80 dark:bg-[#212124]/80 rounded-2xl shadow-xl border border-white/20 dark:border-[#ffffff10]">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-500 dark:text-gray-400 mb-2">Total Components</p>
                        <p class="text-3xl font-bold dark:text-white">1,234</p>
                    </div>
                ...
                <div class="mt-4 pt-2 border-t border-gray-200/30 dark:border-[#ffffff10]">
                    <span class="text-green-500 text-sm"><i class="ri-arrow-up-line"></i> 12% from last month</span>
                </div>
            </div>
            ...
            <div class="p-6 bg-white/80 dark:bg-[#212124]/80 rounded-2xl shadow-xl border border-white/20 dark:border-[#ffffff10]">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-500 dark:text-gray-400 mb-2">Active Categories</p>
                ...
                <div class="mt-4 pt-2 border-t border-gray-200/30 dark:border-[#ffffff10]">
                    <span class="text-red-500 text-sm"><i class="ri-arrow-down-line"></i> 3% from last month</span>
                </div>
            </div>
            ...
            <div class="p-6 bg-white/80 dark:bg-[#212124]/80 rounded-2xl shadow-xl border border-white/20 dark:border-[#ffffff10]">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-500 dark:text-gray-400 mb-2">Total Users</p>
                        <p class="text-3xl font-bold dark:text-white">5,678</p>
                    </div>
                    <div class="w-12 h-12 bg-red-100/50 dark:bg-red-900/20 rounded-xl flex items-center justify-center">
                ...
                <div class="mt-4 pt-2 border-t border-gray-200/30 dark:border-[#ffffff10]">
                    <span class="text-green-500 text-sm"><i class="ri-arrow-up-line"></i> 24% from last month</span>
                </div>
            </div>
            ...
            <div class="p-6 bg-white/80 dark:bg-[#212124]/80 rounded-2xl shadow-xl border border-white/20 dark:border-[#ffffff10]">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-500 dark:text-gray-400 mb-2">Avg. Rating</p>
                        <p class="text-3xl font-bold dark:text-white">4.8</p>
                    </div>
                    <div class="w-12 h-12 bg-red-100/50 dark:bg-red-900/20 rounded-xl flex items-center justify-center">
