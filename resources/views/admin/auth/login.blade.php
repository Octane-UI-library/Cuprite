...
@section('admin_content')
    <div class="min-h-screen bg-gradient-to-br from-red-50 to-rose-100 dark:from-[#0a0a0a] dark:to-[#1a1a1a]">
        <div class="flex items-center justify-center min-h-screen">
            <div
                class="w-full max-w-md p-8 space-y-6 bg-white/80 dark:bg-[#212124]/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 dark:border-[#ffffff10] mx-4">
                <!-- Logo -->
